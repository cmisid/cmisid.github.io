...
Une fois la base de données mise en place, nous créons un service web, permettant notamment à l’application mobile de communiquer avec la base de données, afin de sélectionner, insérer, ou mettre à jour les données.<br/>
